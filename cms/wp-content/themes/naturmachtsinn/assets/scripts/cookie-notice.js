	...
	cookie_groups: [
		{
			...
			cookies: [
				...
				accept: function() {
					...
					el.src = "https://www.googletagmanager.com/gtag/js?id=G-4E13WSTPW1";
					el.async = 1;
					...
					gtag('js', new Date());
					gtag('config', 'G-4E13WSTPW1', { 'anonymize_ip': true });

				},
				reject: function() {
					// Hier kommt der Opt-Out Code rein
					// Folgendes Beispiel für Google Analytics
					var disableStr = 'ga-disable-G-4E13WSTPW1';

					window[disableStr] = true; document.cookie = disableStr + '=true; expires=Thu, 31 Dec 2099 23:59:59 UTC; path=/';

					dywc.cookie.removeItem('_ga', '/', '.hoferholzbau.at');
					dywc.cookie.removeItem('_gid', '/', '.hoferholzbau.at');
					dywc.cookie.removeItem('_gat', '/', '.hoferholzbau.at');
					dywc.cookie.removeItem('_gat_gtag_G-4E13WSTPW1', '/', '.hoferholzbau.at');
				}
			}, {
					...
					accept: function() {
						...
						(function (d) {
							var container = d.querySelector("#gmap-opt-in"),
							  ...
							  gmapSrc = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d50818.6107864661!2d16.054650628832277!3d47.798967578788044!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x476dc5840b1a52d9%3A0xfa4c1feb95fb9e0!2sHofer-Holz-Bau%20Gesellschaft%20mbH!5e0!3m2!1sde!2sat!4v1671158478287!5m2!1sde!2sat";
